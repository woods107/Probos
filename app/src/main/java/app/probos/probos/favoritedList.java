        ...
        deleteButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                try {
                    ...
                    android.app.AlertDialog.Builder settingsMenu = new android.app.AlertDialog.Builder(view.getContext());
        ...
        muteButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    android.app.AlertDialog.Builder muteMenu = new AlertDialog.Builder(view.getContext());
